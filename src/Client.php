...
class Client extends \Docker\API\Runtime\Client\Client
{
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function execStart(string $id, ?\Docker\API\Model\ExecIdStartPostBody $requestBody = null, string $fetch = self::FETCH_OBJECT, array $accept = [])
    {
    ...
    */
     ...
     * 
     *
     * @param null|\Docker\API\Model\VolumeCreateOptions $requestBody 
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     ...
     */
    public function volumeCreate(?\Docker\API\Model\VolumeCreateOptions $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @param null|\Docker\API\Model\VolumesNamePutBody $requestBody 
    * @param array $queryParameters {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function volumeUpdate(string $name, ?\Docker\API\Model\VolumesNamePutBody $requestBody = null, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    *
    * @param null|\Docker\API\Model\PluginPrivilege[] $requestBody 
    * @param array $queryParameters {
